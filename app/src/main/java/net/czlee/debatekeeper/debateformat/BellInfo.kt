 ...
 * @since  2012-05-12
 */
class BellInfo(val bellTime: Long, numberOfBells: Int) {

    var isPauseOnBell = false
    var nextPeriodInfo = PeriodInfo()
    val bellSoundInfo = BellSoundInfo(numberOfBells)

    val isSilent: Boolean
        get() = bellSoundInfo.numberOfBells == 0
}
