...
/**
 * GenericSpeechOrPrepFormat is a generic abstract implementation of {@link SpeechOrPrepFormat}.
 *
 * Subclasses must provide <code>getLength()</code>, <code>getBells()</code> and
 * <code>getFirstPeriodInfo()</code>.
 *
 * GenericSpeechOrPrepFormat will provide other methods using these three methods.
 *
